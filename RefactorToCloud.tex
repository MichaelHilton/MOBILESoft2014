...
\end{tabular}
\nocaptionrule
\caption{Table with the Number Collection API's and corresponding Cloud Table Operations. \TODO{sort by: Direct, Indirect,Custom}}
...
We group the related work in the following categories: (i) cloud-related refactorings, (ii) \TODO{multi-user apps}, and (iii) tools for the end-user development community. \TODO{Danny's paper on SpreadsheetRefactoring}.
