...
In addition, we need to make a choice between using the cloud (i) as a backup for the data for one user across multiple devices(``just me session'') or (ii) to enable collaboration between multiple users across multiple devices (``everyone session''). \FB{These changes were performed in 5 Lines of Code.}
...
Table~\ref{table:CorpusData} provides details about our corpus.  We report the size in LOC and complexity in number of functions.
...
\hline
LOC & 403 & 2,526 & 483 & 47,185 \\
Functions & 21 & 121 & 26 & 2,502 \\
Script Runs & 46 & 750 & 127 & 5,350 \\
Script Installations & 5 & 125 & 18 & 635 \\
