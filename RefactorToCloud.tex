...
Table~\ref{table:CorpusData} provides details about our corpus.  We report the size in LOC and complexity in number of functions.  We also report the number of times the apps were run, as well as the number of installations.
