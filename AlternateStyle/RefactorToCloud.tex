...
\CopyrightYear{2014}
\crdata{978-1-4503-2878-4/14/06}

% --- End of Author Metadata ---

\title{Refactoring Local to Cloud Data Types for Mobile Apps}
...
\alignauthor
Michael Hilton\\
       \affaddr{{\normalsize Oregon State University, USA}}\\
       \email{{\normalsize hiltonm@eecs.oregonstate.edu}}
% 2nd. author
\alignauthor
Arpit Christi\\
       \affaddr{{\normalsize Oregon State University, USA}}\\
       \email{{\normalsize christia@eecs.oregonstate.edu}}
% 3rd. author
\alignauthor Danny Dig\\
       \affaddr{{\normalsize Oregon State University, USA}}\\
       \email{{\normalsize digd@eecs.oregonstate.edu}}
\and  % use '\and' if you need 'another row' of author names
% 4th. author
\alignauthor Micha{\l} Moskal\\
       \affaddr{{\normalsize Microsoft Research, USA}}\\
       \email{{\normalsize Michal.Moskal@microsoft.com}}
% 5th. author
\alignauthor Sebastian Burckhardt\\
       \affaddr{{\normalsize Microsoft Research, USA}}\\
       \email{{\normalsize sburckha@microsoft.com}}
% 6th. author
\alignauthor Nikolai Tillmann\\
       \affaddr{{\normalsize Microsoft Research, USA}}\\
       \email{{\normalsize nikolait@microsoft.com}}
}
...
~\\
\noindent
\textbf{Categories and Subject Descriptors:} D.2.7 [Software Engineering]: Distribution, Maintenance, and Enhancement\\

\vspace{-0.25cm}
\noindent
\textbf{General Terms:} Refactoring\\

\vspace{-0.25cm}
\noindent
\textbf{Keywords:} Refactoring, Cloud Computing, Empirical Study
...
\TD shows a list of currently installed scripts marked with \texttt{\#scriptPlugin} in their description 
when the user taps the plug-in invocation button.
...
The third kind of refactoring is non-trivial: it requires changing the program from using a flat, one-dimensional \code{Collection} to a two-dimensional \code{Cloud Data Table}, as shown in Figure~\ref{fig:ncToCDT}.
 ...
 \begin{figure}[htbp!]
   \vspace{-5pt}
\begin{center}
\includegraphics[width=200pt]{images/convertCollectionToTable}
  \vspace{-5pt}
...
\hline
App  & Primitive & Local Table   & Collection\\
 Name &  to Cloud  &  to  & to Cloud \\
  &    &  Cloud Table  &  \\
\hline
...
\\
\hline
API Name & Number of  &  \% of total \NC  \\
 & Call Sites & API Call Sites \\
\hline
At & 1010 & 39.25 \\
Set At & 632 & 24.56 \\
Add & 532 & 20.68 \\
...
\begin{figure}[h!bt]
\begin{center}
\includegraphics[width=160pt]{images/TransformationsChart}
\vspace{-5pt}
